# 01-Daily — Human Journal (manual only)

**Purpose:** Human-manual daily notes. Obsidian core-plugin auto-creates stubs (`# Daily YYYY-MM-DD`).
**Writers:** Human (lenard) only.
**Readers:** Anyone, read-only.
