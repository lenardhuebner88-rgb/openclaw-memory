...
last_generated: 2026-05-02T23:20:01.507759+00:00
...
**Generated:** 2026-05-02 23:20 UTC  
...
flowchart TB
    ...
    subgraph AGT["🤖 Agents"]
        ...
        agent_efficiency_auditor["efficiency-auditor<br/>6h ago<br/>106 KB"]
        agent_frontend_guru["frontend-guru<br/>8d ago<br/>180 KB"]
        agent_james["james<br/>5h ago<br/>195 KB"]
        agent_main["main<br/>29m ago<br/>1528 KB"]
        agent_spark["spark<br/>14h ago<br/>248 KB"]
        agent_sre_expert["sre-expert<br/>42m ago<br/>373 KB"]
        agent_system_bot["system-bot<br/>4h ago<br/>158 KB"]
...
| `efficiency-auditor` | 6h ago | 106 | `/home/piet/.openclaw/agents/efficiency-auditor` |
| `frontend-guru` | 8d ago | 180 | `/home/piet/.openclaw/agents/frontend-guru` |
| `james` | 5h ago | 195 | `/home/piet/.openclaw/agents/james` |
| `main` | 29m ago | 1528 | `/home/piet/.openclaw/agents/main` |
| `spark` | 14h ago | 248 | `/home/piet/.openclaw/agents/spark` |
| `sre-expert` | 42m ago | 373 | `/home/piet/.openclaw/agents/sre-expert` |
| `system-bot` | 4h ago | 158 | `/home/piet/.openclaw/agents/system-bot` |
...
```
14828bd 2026-05-03 auto-sync: 2026-05-03 01:01
