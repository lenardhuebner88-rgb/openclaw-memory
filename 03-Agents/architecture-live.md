...
last_generated: 2026-04-28T03:00:02.202394+00:00
...
flowchart TB
    ...
    subgraph AGT["🤖 Agents"]
        ...
        agent_efficiency_auditor["efficiency-auditor<br/>14h ago<br/>337 KB"]
        agent_frontend_guru["frontend-guru<br/>5h ago<br/>201 KB"]
        agent_james["james<br/>10h ago<br/>995 KB"]
        agent_main["main<br/>8m ago<br/>2540 KB"]
        agent_spark["spark<br/>6h ago<br/>5891 KB"]
        agent_sre_expert["sre-expert<br/>8m ago<br/>22 KB"]
...
- **Atlas session-size telemetry:** info only — `[2026-04-28T03:00:02Z] CRITICAL session=db928813-764 pct=433%`
- **Graph edges:** 1279
- **Rules active:** 57
...
| `efficiency-auditor` | 14h ago | 337 | `/home/piet/.openclaw/agents/efficiency-auditor` |
| `frontend-guru` | 5h ago | 201 | `/home/piet/.openclaw/agents/frontend-guru` |
| `james` | 10h ago | 995 | `/home/piet/.openclaw/agents/james` |
| `main` | 8m ago | 2540 | `/home/piet/.openclaw/agents/main` |
| `spark` | 6h ago | 5891 | `/home/piet/.openclaw/agents/spark` |
| `sre-expert` | 8m ago | 22 | `/home/piet/.openclaw/agents/sre-expert` |
...
```
[2026-04-28T02:40:01Z] CRITICAL session=db928813-764 pct=394%
[2026-04-28T02:45:01Z] CRITICAL session=db928813-764 pct=413%
[2026-04-28T02:50:01Z] OK session=1726e732-57d pct=3%
[2026-04-28T02:55:01Z] CRITICAL session=db928813-764 pct=433%
[2026-04-28T03:00:02Z] CRITICAL session=db928813-764 pct=433%
```
