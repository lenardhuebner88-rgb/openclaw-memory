...
last_generated: 2026-04-28T02:30:01.967415+00:00
...
**Generated:** 2026-04-28 02:30 UTC  
...
flowchart TB
    ...
    subgraph AGT["🤖 Agents"]
        ...
        agent_efficiency_auditor["efficiency-auditor<br/>13h ago<br/>337 KB"]
        agent_frontend_guru["frontend-guru<br/>5h ago<br/>201 KB"]
        agent_james["james<br/>9h ago<br/>995 KB"]
        agent_main["main<br/>5m ago<br/>2203 KB"]
        agent_spark["spark<br/>6h ago<br/>5891 KB"]
        agent_sre_expert["sre-expert<br/>5m ago<br/>34 KB"]
...
- **Atlas session-size telemetry:** info only — `[2026-04-28T02:30:01Z] CRITICAL session=db928813-764 pct=376%`
- **Graph edges:** 1279
- **Rules active:** 57
- **Facts (all-time):** 287 across 1 daily files
- **Facts today:** None
- **Scripts (active, no .bak):** 100 root + 65 workspace = 165
- **Cron entries (live):** 46
...
| `efficiency-auditor` | 13h ago | 337 | `/home/piet/.openclaw/agents/efficiency-auditor` |
| `frontend-guru` | 5h ago | 201 | `/home/piet/.openclaw/agents/frontend-guru` |
| `james` | 9h ago | 995 | `/home/piet/.openclaw/agents/james` |
| `main` | 5m ago | 2203 | `/home/piet/.openclaw/agents/main` |
| `spark` | 6h ago | 5891 | `/home/piet/.openclaw/agents/spark` |
| `sre-expert` | 5m ago | 34 | `/home/piet/.openclaw/agents/sre-expert` |
| `test-lock` | n/a | 0 | `/home/piet/.openclaw/agents/test-lock` |
| `worker` | n/a | 0 | `/home/piet/.openclaw/agents/worker` |

## 🛡️ Defense-Crons (46 active, by tier)
...
```
[2026-04-28T02:10:01Z] CRITICAL session=db928813-764 pct=339%
[2026-04-28T02:15:01Z] CRITICAL session=db928813-764 pct=357%
[2026-04-28T02:20:01Z] CRITICAL session=db928813-764 pct=357%
[2026-04-28T02:25:01Z] CRITICAL session=db928813-764 pct=376%
[2026-04-28T02:30:01Z] CRITICAL session=db928813-764 pct=376%
```
...
```
d2d930d 2026-04-28 auto-sync: 2026-04-28 04:28
409993f 2026-04-28 auto-sync: 2026-04-28 03:57
5f57436 2026-04-28 auto-sync: 2026-04-28 03:27
03f03d7 2026-04-28 chore(config-backup): snapshot 2026-04-28
891e8c9 2026-04-28 auto-sync: 2026-04-28 02:57
```
