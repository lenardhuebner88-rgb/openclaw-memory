...
last_generated: 2026-05-03T11:50:01.970592+00:00
...
**Generated:** 2026-05-03 11:50 UTC  
...
flowchart TB
    ...
    subgraph AGT["🤖 Agents"]
        ...
        agent_efficiency_auditor["efficiency-auditor<br/>18h ago<br/>106 KB"]
        agent_frontend_guru["frontend-guru<br/>8d ago<br/>180 KB"]
        agent_james["james<br/>18h ago<br/>195 KB"]
        agent_main["main<br/>1s ago<br/>2575 KB"]
        agent_spark["spark<br/>1d ago<br/>248 KB"]
        agent_sre_expert["sre-expert<br/>5h ago<br/>49 KB"]
        agent_system_bot["system-bot<br/>5h ago<br/>20 KB"]
...
| `efficiency-auditor` | 18h ago | 106 | `/home/piet/.openclaw/agents/efficiency-auditor` |
| `frontend-guru` | 8d ago | 180 | `/home/piet/.openclaw/agents/frontend-guru` |
| `james` | 18h ago | 195 | `/home/piet/.openclaw/agents/james` |
| `main` | 1s ago | 2575 | `/home/piet/.openclaw/agents/main` |
| `spark` | 1d ago | 248 | `/home/piet/.openclaw/agents/spark` |
| `sre-expert` | 5h ago | 49 | `/home/piet/.openclaw/agents/sre-expert` |
| `system-bot` | 5h ago | 20 | `/home/piet/.openclaw/agents/system-bot` |
