...
last_generated: 2026-04-27T13:00:01.244577+00:00
...
**Generated:** 2026-04-27 13:00 UTC  
...
flowchart TB
    ...
    subgraph AGT["🤖 Agents"]
        ...
        agent_efficiency_auditor["efficiency-auditor<br/>12m ago<br/>337 KB"]
        agent_frontend_guru["frontend-guru<br/>13m ago<br/>2385 KB"]
        agent_james["james<br/>22h ago<br/>157 KB"]
        agent_main["main<br/>3s ago<br/>4887 KB"]
        agent_spark["spark<br/>18h ago<br/>17 KB"]
        agent_sre_expert["sre-expert<br/>1m ago<br/>234 KB"]
...
- **Atlas session-size telemetry:** info only — `[2026-04-27T13:00:01Z] CRITICAL session=871a2caa-44f pct=834%`
- **Graph edges:** 1279
- **Rules active:** 57
...
| `efficiency-auditor` | 12m ago | 337 | `/home/piet/.openclaw/agents/efficiency-auditor` |
| `frontend-guru` | 13m ago | 2385 | `/home/piet/.openclaw/agents/frontend-guru` |
| `james` | 22h ago | 157 | `/home/piet/.openclaw/agents/james` |
| `main` | 3s ago | 4887 | `/home/piet/.openclaw/agents/main` |
| `spark` | 18h ago | 17 | `/home/piet/.openclaw/agents/spark` |
| `sre-expert` | 1m ago | 234 | `/home/piet/.openclaw/agents/sre-expert` |
...
```
[2026-04-27T12:40:02Z] OK session=871a2caa-44f pct=58%
[2026-04-27T12:45:01Z] CRITICAL session=871a2caa-44f pct=610%
[2026-04-27T12:50:01Z] CRITICAL session=871a2caa-44f pct=694%
[2026-04-27T12:55:01Z] CRITICAL session=871a2caa-44f pct=694%
[2026-04-27T13:00:01Z] CRITICAL session=871a2caa-44f pct=834%
```
