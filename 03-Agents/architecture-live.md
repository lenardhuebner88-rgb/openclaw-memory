...
last_generated: 2026-05-03T17:50:01.522034+00:00
...
flowchart TB
    ...
    subgraph AGT["🤖 Agents"]
        ...
        agent_efficiency_auditor["efficiency-auditor<br/>4h ago<br/>168 KB"]
        agent_frontend_guru["frontend-guru<br/>4h ago<br/>47 KB"]
        agent_james["james<br/>1h ago<br/>9 KB"]
        agent_main["main<br/>16s ago<br/>1019 KB"]
        agent_spark["spark<br/>1d ago<br/>248 KB"]
        agent_sre_expert["sre-expert<br/>5m ago<br/>77 KB"]
        agent_system_bot["system-bot<br/>46m ago<br/>1 KB"]
...
| `efficiency-auditor` | 4h ago | 168 | `/home/piet/.openclaw/agents/efficiency-auditor` |
| `frontend-guru` | 4h ago | 47 | `/home/piet/.openclaw/agents/frontend-guru` |
| `james` | 1h ago | 9 | `/home/piet/.openclaw/agents/james` |
| `main` | 16s ago | 1019 | `/home/piet/.openclaw/agents/main` |
| `spark` | 1d ago | 248 | `/home/piet/.openclaw/agents/spark` |
| `sre-expert` | 5m ago | 77 | `/home/piet/.openclaw/agents/sre-expert` |
| `system-bot` | 46m ago | 1 | `/home/piet/.openclaw/agents/system-bot` |
