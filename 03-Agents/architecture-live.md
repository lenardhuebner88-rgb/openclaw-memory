...
last_generated: 2026-05-03T13:50:01.243701+00:00
...
flowchart TB
    ...
    subgraph AGT["🤖 Agents"]
        ...
        agent_efficiency_auditor["efficiency-auditor<br/>23m ago<br/>6 KB"]
        agent_frontend_guru["frontend-guru<br/>23m ago<br/>2 KB"]
        agent_james["james<br/>23m ago<br/>2 KB"]
        agent_main["main<br/>22s ago<br/>110 KB"]
        agent_spark["spark<br/>1d ago<br/>248 KB"]
        agent_sre_expert["sre-expert<br/>24m ago<br/>46 KB"]
        agent_system_bot["system-bot<br/>13m ago<br/>8 KB"]
...
| `efficiency-auditor` | 23m ago | 6 | `/home/piet/.openclaw/agents/efficiency-auditor` |
| `frontend-guru` | 23m ago | 2 | `/home/piet/.openclaw/agents/frontend-guru` |
| `james` | 23m ago | 2 | `/home/piet/.openclaw/agents/james` |
| `main` | 22s ago | 110 | `/home/piet/.openclaw/agents/main` |
| `spark` | 1d ago | 248 | `/home/piet/.openclaw/agents/spark` |
| `sre-expert` | 24m ago | 46 | `/home/piet/.openclaw/agents/sre-expert` |
| `system-bot` | 13m ago | 8 | `/home/piet/.openclaw/agents/system-bot` |
...
df649da 2026-05-03 auto-sync: 2026-05-03 13:31
```
