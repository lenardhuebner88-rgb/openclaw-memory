...
last_generated: 2026-05-03T20:50:01.664224+00:00
...
flowchart TB
    ...
    subgraph AGT["🤖 Agents"]
        ...
        agent_efficiency_auditor["efficiency-auditor<br/>7m ago<br/>36 KB"]
        agent_frontend_guru["frontend-guru<br/>7h ago<br/>47 KB"]
        agent_james["james<br/>4h ago<br/>9 KB"]
        agent_main["main<br/>14s ago<br/>406 KB"]
        agent_spark["spark<br/>1d ago<br/>248 KB"]
        agent_sre_expert["sre-expert<br/>11m ago<br/>78 KB"]
        agent_system_bot["system-bot<br/>2m ago<br/>11 KB"]
...
| `efficiency-auditor` | 7m ago | 36 | `/home/piet/.openclaw/agents/efficiency-auditor` |
| `frontend-guru` | 7h ago | 47 | `/home/piet/.openclaw/agents/frontend-guru` |
| `james` | 4h ago | 9 | `/home/piet/.openclaw/agents/james` |
| `main` | 14s ago | 406 | `/home/piet/.openclaw/agents/main` |
| `spark` | 1d ago | 248 | `/home/piet/.openclaw/agents/spark` |
| `sre-expert` | 11m ago | 78 | `/home/piet/.openclaw/agents/sre-expert` |
| `system-bot` | 2m ago | 11 | `/home/piet/.openclaw/agents/system-bot` |
