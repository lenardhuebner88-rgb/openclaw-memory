...
Output: /home/piet/vault/03-Agents/claude-design-packs/mc-design-pack-<focus>-<timestamp>.zip
...
VAULT_PACKS = Path("/home/piet/vault/03-Agents/claude-design-packs")
...
def copy_screenshots(pack_root: Path, focus: str) -> int:
    ...
    src_dirs = [
        MC / "screenshots",
        Path("/home/piet/vault/03-Agents/Atlas Main"),  # placeholder
    ]
