#!/usr/bin/env python3
"""
QMD OpenRouter Embedding Script v2
Uses OpenRouter text-embedding-3-small with 768 dimensions and writes directly to QMD's vectors_vec
table via the sqlite-vec extension.
"""
