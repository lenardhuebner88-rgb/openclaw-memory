...
- 2026-04-08: Opus usage constrained to high-value cases (root-cause, architecture, severe bugs).
- 2026-04-08: Mission Control switched to production service (`next start`) for lower memory and stability.
